...
/**
 * Filter to add the scroll template wrapper for this banner template.
 *
 */
...
add_action( 'swsales_banner_content_scroll', __NAMESPACE__ . '\swsales_banner_content_scroll' );

/**
 * Filter to add the scroll template wrapper for this landing page template.
 *
 */
